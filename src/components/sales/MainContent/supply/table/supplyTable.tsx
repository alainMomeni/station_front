...
import StatusFilterSupplyTable from "./StatusFilterSupplyTable";
import SearchAndFilterSupplyTable from "./SearchAndFilterSupplyTable";
import PaginationSupplyTable from "./paginationSupplyTable";
import SupplyTableButtons from "./SupplyTableButtons";
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="bg-white rounded-3xl shadow-md p-3 sm:p-4 md:p-6">
        ...
        <div className="w-full lg:w-auto mb-4 lg:mb-0 pr-4">
          ...
          <StatusFilterSupplyTable selectedStatus={selectedStatus} handleStatusSelect={setSelectedStatus} />
        </div>
        </div>
          <SearchAndFilterSupplyTable selectedFilter={selectedFilter} handleFilterSelect={setSelectedFilter} />
        </div>
